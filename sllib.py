...
class SpiderLab:
    ...
    Attributes:
        dbh (SpiderLabDb): database handle
        scanId (str): scan ID this instance of SpiderLab is being used in
    ...
    def scanId(self, scanId: str) -> str:
        """Set the scan ID this instance of SpiderLab is being used in.
    ...
    def socksProxy(self, socksProxy: str) -> str:
        ...
        modules. slscan will call this to update the socket reference
        to the SOCKS one.
    ...
    def cachePut(self, label: str, data: str) -> None:
        ...
        cacheFile = SpiderLabHelpers.cachePath() + "/" + pathLabel
    ...
    def configSerialize(self, opts: dict, filterSystem: bool = True):
        ...
        Args:
            opts (dict): Dictionary of SpiderLab configuration options
    ...
    def configUnserialize(self, opts: dict, referencePoint: dict, filterSystem: bool = True):
        ...
        Args:
            opts (dict): SpiderLab configuration options
    ...
    def urlFQDN(self, url: str) -> str:
        ...
        baseurl = SpiderLabHelpers.urlBaseUrl(url)
        if '://' in baseurl:
            count = 2
        else:
            count = 0
    ...
    def validHost(self, hostname: str, tldList: str) -> bool:
        ...
        slx = ps.privatesuffix(hostname)
        return slx is not None
    ...
    def fetchUrl(
        ...
        if sizeLimit or headOnly:
            ...
            if newloc.startswith("/") or newloc.startswith("../"):
                newloc = SpiderLabHelpers.urlBaseUrl(url) + newloc
            ...
            try:
                ...
                if source == "circl":
                    ...
                    if rating:
                        ...
                        return (eventType, f"{cveId}\n<SLURL>https://nvd.nist.gov/vuln/detail/{cveId}</SLURL>\n"
